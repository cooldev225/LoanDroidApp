...
{
    public class ApplicationClient:ApplicationUser{
        public List<AccountPayment> AccountPayment { get; set; }
        public ApplicationClient(ApplicationUser user) {
            this.Id = user.Id;
    ...
    public class DatatableClient: IDatatable
    {
        public DatatablePagination meta { get; set; }
        public List<ApplicationClient> data { get; set; }
    }
}
