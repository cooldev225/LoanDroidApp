...
namespace DBSetup
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task CreatePagesAsync()
        {
            ...
            pages.Add(new ApplicationPage { Name = "Gestión de préstamos", PageGroup = PageGroup.Prestamo, Claims = "loan.representante,loan.request,loan.service,loan.debug,loan.collection", Order = 4, });
            pages.Add(new ApplicationPage { Name = "Gestión de inversiones", PageGroup = PageGroup.Inversion, Claims = "investment.representante,investment.request,investment.service,investment.debug,investment.collection", Order = 5, });
            try
            {
