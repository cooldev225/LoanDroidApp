    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await EnsureRoleAsync(debuggerdepartmentRoleName, "Default debugger department", new string[] { });
                await EnsureRoleAsync(collectiondepartmentRoleName, "Default collection department", new string[] { });
        ...
        public async Task CreatePagesAsync()
        {
            ...
            pages.Add(new ApplicationPage { Name = "Gestión de préstamos", PageGroup = PageGroup.Prestamo, Claims = "loan.request,loan.debug,loan.collection", Order = 4, });
            pages.Add(new ApplicationPage { Name = "Gestión de inversiones", PageGroup = PageGroup.Inversion, Claims = "investment.debug,investment.collection", Order = 5, });
            try
            {
