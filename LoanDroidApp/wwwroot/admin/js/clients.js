                ...
                },
                {
                    ...
                    template: function (row) {
                        return $("#managepermission").val() == "false" ?'':'\
                            ...
                            '<a onclick="javascript:confirm(\'' + lang.users_alert_confirmresetpassword + '\')?resetPassword(\'' + row.id + '\'):\'\';" class="btn btn-sm btn-clean btn-icon" title="Reset password">\
                            ...
                            '<a onclick="javascript:confirm(\'' + lang.clients_alert_confirmdeleteauser + ' ' + row.userName + '?\')?deleteUser(\'' + row.id + '\'):\'\';" class="btn btn-sm btn-clean btn-icon" title="Reset password">\
